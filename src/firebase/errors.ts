...
export const isInFirebaseErrorMessages = (
  code: string
): code is keyof typeof FirebaseErrorMessages => code in FirebaseErrorMessages;

export const getFirebaseErrorMessage = (e: Error): string => {
